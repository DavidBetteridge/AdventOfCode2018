...
func createStar(line: String) -> Star {
    let replaced = line
    ...
    return Star(StartX: Int(parts[0])!, StartY: Int(parts[1])!, SpeedX: Int(parts[2])!, SpeedY:Int(parts[3])!)
}

func calculateNumberOfSeconds(stars: [Star]) -> Int {
    var smallestDifferenceX = 999999;
    var differenceInX = 999999;
    var seconds = 1;
...
func positionAtTime(star: Star, seconds: Int) -> Position
{
...
func starsAtTime(stars: [Star], seconds: Int) -> [Position]
{
    return stars.map {positionAtTime(star: $0, seconds: seconds)}
}

func drawStarField(stars: [Position], seconds: Int)
{
